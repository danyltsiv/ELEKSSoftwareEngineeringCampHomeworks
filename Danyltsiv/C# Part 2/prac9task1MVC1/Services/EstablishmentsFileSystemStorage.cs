...
namespace prac9task1MVC1.Services
{
    public class EstablishmentsFileSystemStorage : IEstablishmentStorage
    {
        ...
        public void Edit(Establishment establishment)
        {
            ...
            establishments.FirstOrDefault(t => t.establishmentId == establishment.establishmentId).Address = establishment.Address;
            establishments.FirstOrDefault(t => t.establishmentId == establishment.establishmentId).Opened = establishment.Opened;
            establishments.FirstOrDefault(t => t.establishmentId == establishment.establishmentId).Name = establishment.Name;
            establishments.FirstOrDefault(t => t.establishmentId == establishment.establishmentId).Rating = establishment.Rating;
            SaveChanges(establishments);
        }
        ...
        private void Initialize()
        {
            ...
            {
                new Establishment("Restaurant") { Address="Address",  Opened = false, Rating = 1 }
            };
            SaveChanges(establishments);
        }
